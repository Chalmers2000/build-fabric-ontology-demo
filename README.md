...
5. Run the Create_Healthcare_Ontology notebook. Creating the graph is slow: it can take 15 minutes on an F64 capacity before everything is ready.
...
8. Try it out! See how the data_agent_prompts.md work
